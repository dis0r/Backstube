...
const CACHE_NAME = 'back-assistent-pro-v0-23-0';
const APP_SHELL = [
  './index.html',
  './manifest.json',
  './icon-192.png',
...
// offline), im Hintergrund parallel neu laden und Cache aktualisieren,
// damit die nächste Sitzung wieder aktuell ist.
